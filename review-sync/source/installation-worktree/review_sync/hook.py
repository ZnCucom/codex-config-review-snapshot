...
from .registration import match_project
...
def handle_hook(
    ...
    try:
        ...
        return output
    try:
        matched = match_project(projects, identity, data_root, runner)
    except (OSError, KeyError, TypeError, ValueError, GitError, PolicyError):
        return output
    if matched is None:
        return output
    try:
