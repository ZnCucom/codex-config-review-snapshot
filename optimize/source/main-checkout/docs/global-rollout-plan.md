...
Stages 1–4 are **planned and unapplied**. Optimize v1.1 is approved as an engineering release candidate. Real Teaching AI adoption and real user-level installation remain separate controlled actions.
